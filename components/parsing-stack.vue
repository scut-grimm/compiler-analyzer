...
<script>
  ...
  export default {
    ...
    methods:{
      ...
      start(){
        const algorithm = new GenerateParsingStack(this.grammar,this.PPT,this.inputData)
    ...
    mounted() {
      ...
      this.strToken= [grammar.getSign('id', 'Terminal'),grammar.getSign('*', 'Terminal'),grammar.getSign('id', 'Terminal')]
      this.inputData = [grammar.getSign('id', 'Terminal'),grammar.getSign('*', 'Terminal'),grammar.getSign('id', 'Terminal')]
